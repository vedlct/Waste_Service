...
import { ArrowLeft, Check, Minus, Plus, ShieldCheck, ShoppingBasket, Trash2 } from 'lucide-react'
import { useCart } from '../cart/CartContext'

export default function Checkout() {
  const { items, ready, count, total, updateQuantity, removeItem, clearCart } = useCart()
  if (!ready) return <div className='min-h-[55vh]' />

  return <main className='min-h-screen bg-[#f3f6f7] px-4 pb-20 pt-32 sm:px-6 lg:px-8 lg:pt-36'><div className='mx-auto max-w-7xl'>
