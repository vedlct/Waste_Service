...
const categories = [
  {
    ...
    items: [
      '3 Piece Suites', 'Armchairs', 'Bath Frames', 'Bathroom Furniture', 'Bed Frames',
      'Bedside Tables', 'Blinds', 'Book Cases', 'Cabinets', 'Carpets', 'Chairs',
      'Chests of Drawers', 'Coffee Tables', 'Conservatory Furniture', 'Console Tables',
      'Cupboards', 'Curtains', 'Cushions', 'Desks', 'Dining Room Chairs',
      'Dining Room Tables', 'Display cabinets', 'Door', 'Gaming Chairs', 'Garden Benches',
      'Garden Chairs', 'Garden Furniture', 'Kitchen Lighting', 'Kitchen Tables',
      'Laminate Flooring', 'Lamps', 'Large TVs', 'Mattresses', 'Metal Bed Frames',
      'Mirrors', 'Office Chairs', 'Office Furniture', 'Radiators', 'Rise & Recline Chairs',
      'Rugs', 'Shelves', 'Side tables', 'Sofas', 'Tables', 'Wardrobes', 'Wooden Beds',
    ],
  },
];

const highlightImages = [
  { src: '/images/furnitureRubbish1.jpg', alt: 'Household waste prepared for collection' },
  { src: '/images/furnitureRubbish2.jpg', alt: 'Household items ready for responsible removal' },
  { src: '/images/furnitureRubbish3.jpg', alt: 'Clearance materials organised for collection' },
  { src: '/images/furnitureRubbish4.jpg', alt: 'Waste clearance team handling a collection' },
];

export default function FurnitureRubbishItems () {
  return (
