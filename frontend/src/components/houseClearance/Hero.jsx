  ...
  return (
    <section className="relative isolate min-h-[620px] overflow-hidden bg-sky-50 sm:min-h-[660px] lg:min-h-[700px]">
      ...
      <div className="mx-auto flex min-h-[620px] w-full max-w-7xl items-end px-4 py-8 sm:min-h-[660px] sm:px-6 sm:py-10 lg:min-h-[700px] lg:items-center lg:justify-end lg:px-8 lg:py-16">
        <div className="group relative w-full overflow-hidden rounded-[1.75rem] border border-sky-200 bg-white/30 p-6 text-[#102a4c] shadow-[0_28px_70px_-30px_rgba(2,14,33,0.9)] backdrop-blur-md transition duration-500 hover:-translate-y-1 hover:border-white/35 sm:p-8 lg:w-[min(36rem,48%)] lg:p-10">
          <div className="absolute left-0 top-0 h-full w-1.5 bg-[#0492E8]" aria-hidden="true" />
          <div className="flex items-center gap-3 text-xs font-extrabold uppercase tracking-[0.18em] text-[#0492E8] sm:text-sm">
            <span className="h-px w-8 bg-[#0492E8]" aria-hidden="true" />
          ...
          <div className="mt-6 grid gap-2 sm:grid-cols-2">
            {['Flexible collection times', 'Responsible waste handling'].map((item) => (
              <div key={item} className="flex items-center gap-2 text-xs font-semibold text-[#102a4c]/90 sm:text-sm">
                <span className="grid size-6 shrink-0 place-items-center rounded-full bg-[#0492E8] text-white">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/#prices"
              className="group/cta inline-flex min-h-12 flex-1 items-center justify-center gap-2 rounded-full bg-[#0492E8] px-5 py-3 text-sm font-extrabold text-white hover:text-[#102a4c] transition duration-300 hover:-translate-y-0.5 hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
            >
              Check prices &amp; book
