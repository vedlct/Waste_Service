                ...
                <div className="grid gap-5 sm:grid-cols-[4rem_1fr] sm:gap-6">
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="hidden size-12 shrink-0 place-items-center rounded-full border border-[#102a4c]/15 text-[#102a4c] group-hover/category:text-white transition duration-500 group-hover/category:rotate-12 group-hover/category:border-[#0492E8] group-hover/category:bg-[#0492E8] sm:grid">
