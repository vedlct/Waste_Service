    ...
    <section className='relative flex min-h-svh w-full items-center overflow-hidden bg-sky-50 text-[#102a4c]'>
      ...
      <div className='relative mx-auto w-full max-w-7xl px-4 pb-10 pt-28 sm:px-6 sm:pb-12 sm:pt-32 lg:px-8 lg:pb-60 lg:pt-36 leading-tight'>
        <div className='max-w-3xl rounded-[2rem] border border-sky-200 bg-white/10 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8 lg:p-10'>
          ...
          <h1 className='mt-3 text-xl font-black leading-[1.02] tracking-[-0.045em] sm:text-3xl'>
            Waste gone.
          ...
          <div className='mt-5 flex flex-col gap-3 sm:flex-row sm:items-center'>
            ...
            <Link href='/contactUs' className='group inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/30 bg-white/10 px-4 py-2 xl:px-6 xl:py-3 text-sm font-black text-[#102a4c] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white hover:bg-white hover:text-[#11224D] hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white sm:w-auto sm:text-base'>
              Talk to our team
              <ArrowRight aria-hidden='true' className='size-5 transition-transform duration-300 group-hover:translate-x-1' />
            </Link>
          </div>
          ...
          <div className='mt-5 grid max-w-2xl grid-cols-1 gap-2.5 min-[760px]:grid-cols-3 sm:gap-3'>
            {assurances.map((item) => {
              ...
              return (
                <div key={item.value} className='group flex items-center gap-3 rounded-2xl border border-white/15 bg-white/80 p-3 shadow-sm backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white/35 hover:bg-white/95 hover:shadow-lg sm:p-2'>
