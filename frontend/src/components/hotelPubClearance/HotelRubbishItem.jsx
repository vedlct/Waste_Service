...
const categories = [
  {
    number: '01',
    title: 'Hotels & Pub Rubbish Removal Waste Clearance',
    summary: 'Typically Hotel & Pub Waste Collection Services are used when refurbishing single rooms or whole parts of your building.',
    items: [
      'Refurb Rooms Cleared', 'Old Reception Cleared', 'Bars Cleared', 'Strip out',
      'Beds & Wardrobes', 'Mattresses', 'Furniture', 'Kitchens & Bathroom Rubbish',
      'Fly Tipping Cleared', 'Site Clearance', 'Builders Waste & Rubble Removal',
      'Land Rubbish Clearance', 'Garden Furniture',
    ],
  },
];

const highlightImages = [
  { src: '/images/load1.jpg', alt: 'Household waste prepared for collection' },
  { src: '/images/load2.jpg', alt: 'Household items ready for responsible removal' },
  { src: '/images/load3.jpg', alt: 'Clearance materials organised for collection' },
  { src: '/images/load4.jpg', alt: 'Waste clearance team handling a collection' },
];


export default function HotelRubbishItem () {
  return (
