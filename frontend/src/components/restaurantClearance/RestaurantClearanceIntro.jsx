        ...
        <div className="grid gap-9 lg:grid-cols-[0.85fr_1.15fr] lg:items-end lg:gap-16">
          <div>
            ...
            <h2 className="mt-5 text-3xl font-bold leading-[1.04] tracking-tight text-[#102a4c] sm:text-4xl lg:text-4xl">
              Clear the premises.
              <span className="block text-[#0492E8]">Protect your next opening.</span>
            </h2>
          </div>

          <div className="border-l-2 border-[#0492E8] pl-5 sm:pl-7">
        ...
        <ol className="mt-12 border-t border-[#102a4c]/15 lg:mt-16">
          {clearanceAreas.map(({ icon: Icon, label, title, description }, index) => (
            <li key={title} className="group grid gap-5 border-b border-[#102a4c]/15 py-8 transition duration-500 hover:bg-white hover:px-4 md:grid-cols-[3rem_4rem_0.9fr_1.1fr] sm:items-center lg:gap-8 lg:py-9">
              <span className="text-xs font-black tracking-[0.15em] text-[#0492E8]">0{index + 1}</span>
              <span className="grid size-13 place-items-center rounded-full border border-sky-200 bg-sky-50 text-[#102a4c] transition duration-500 group-hover:rotate-6 group-hover:bg-[#0492E8] group-hover:text-white">
                <Icon className="size-6" strokeWidth={1.8} aria-hidden="true" />
              </span>
              <div>
                <p className="text-[0.68rem] font-extrabold uppercase tracking-[0.17em] text-[#0492E8]">{label}</p>
        ...
        <div className="mt-12 overflow-hidden rounded-[2rem] border border-sky-200 bg-sky-50 text-[#102a4c]">
          <div className="grid lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="p-7 sm:p-9 lg:p-10">
              <div className="flex items-center gap-3 text-xs font-extrabold uppercase tracking-[0.17em] text-[#0492E8]">
              ...
              <div className="mt-5 flex flex-col gap-3 text-sm font-semibold text-[#102a4c]/75 sm:flex-row sm:gap-6 sm:text-base">
                <span className="flex items-center gap-2"><Check className="size-4 text-[#0492E8]" strokeWidth={3} />Flexible collection times</span>
                <span className="flex items-center gap-2"><ShieldCheck className="size-4 text-[#0492E8]" />Fully insured waste carrier</span>
              </div>
            </div>

            <div className="flex flex-col gap-3 border-t border-white/10 p-7 sm:flex-row lg:border-l lg:border-t-0 lg:p-9">
              <Link href="/#prices" className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#0492E8] px-6 py-3 text-sm font-extrabold text-white hover:text-[#102a4c] transition duration-300 hover:-translate-y-0.5 hover:bg-white focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">
