    ...
    <section class="login-shell">
        <div class="login-showcase">
            ...
            <div class="login-copy">
                <p class="small fw-bold text-uppercase text-warning mb-2">Content operations</p>
                <h1 class="display-6 fw-black mb-3">Manage the site with a cleaner, faster workspace.</h1>
                <p class="mb-0 text-white-50">Services, prices, bookings and customer content will live here as the admin panel grows.</p>
            </div>
        </div>
        ...
        <div class="login-card">
            <div class="mb-4">
                ...
                <p class="small fw-bold text-uppercase text-primary mb-2">Secure admin login</p>
                <h2 class="fw-black mb-2">Welcome back</h2>
                <p class="text-muted mb-0">Sign in to continue to the MR. TEE admin panel.</p>
            </div>
