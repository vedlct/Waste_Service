...
Use this directory for project understanding that should outlive individual tasks.
...
- `../frontend` - cloned frontend application from `git@github.com:vedlct/Waste_Service.git`.
- `../backend` - Laravel application for the future admin panel, CMS, and API.
